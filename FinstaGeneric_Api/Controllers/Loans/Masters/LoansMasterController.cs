...
namespace FinstaApi.Controllers.Loans.Masters
{
    ...
    public class LoansMasterController : ControllerBase
    {
        ...
        public List<LoansMasterDTO> getLoanTypes()
        {
        ...
        public List<loanconfigurationDTO> getLoanpayins()
        {
        ...
        public List<loanconfigurationDTO> getLoanInterestratetypes()
        {
        ...
        public List<LoansMasterDTO> getLoanMasterDetails()
        {
            lstLoanMasterdetails = new List<LoansMasterDTO>();
            try
            {
        ...
        public IActionResult checkInsertLoanNameandCodeDuplicates(string checkparamtype,string loanname,string loancode)
        {
            int count = 0;
            lstLoanMasterdetails = new List<LoansMasterDTO>();
            try
            {
                count = objLoanmaster.checkInsertLoanNameandCodeDuplicates(checkparamtype,loanname, loancode,Con);
            }
            catch (Exception ex)
            {
                throw new FinstaAppException(ex.ToString());
